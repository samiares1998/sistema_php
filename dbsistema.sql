...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-05-2022 a las 03:50:12
...
(4, 'Cliente', 'EEEEE111', 'DNI', '20918', 'Conocido', '19827', 'ajhd@gmail.com'),
...
(1, 'Admin', 'DNI', '63238', 'Conocido', '27386126', 'admin@gmail.com', '', 'admin', '8C6976E5B5410415BDE908BD4DEE15DFB167A9C873FC4BB8A81F6F2AB448A918', '', 1);
...
(9, 5, 1, 'Factura', '', '01000', '2022-04-29 00:00:00', '0.00', '56000.00', 'Aceptado');
...
--
ALTER TABLE `detalle_venta`
  MODIFY `iddetalle_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
